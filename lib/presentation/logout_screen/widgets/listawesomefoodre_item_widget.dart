...
class ListawesomefoodreItemWidget extends StatelessWidget {
  ListawesomefoodreItemWidget(this.listawesomefoodreItemModelObj);

  ListawesomefoodreItemModel listawesomefoodreItemModelObj;
